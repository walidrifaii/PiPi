/**
 * Seeds Hayat Donar menu categories and products from scripts/data/hayat-donur.json.
 *
 ...
 *   (currency is ignored — not stored in schema)
 *
 * Usage (from repo root):
 *   node scripts/seed-hayat-donur-catalog.mjs
 *
 * Env:
...
const dataPath = path.join(__dirname, "data", "hayat-donur.json");
...
try {
  ...
  for (const product of catalog.products) {
    ...
    const existingProductId = productIdByCategoryAndName.get(
