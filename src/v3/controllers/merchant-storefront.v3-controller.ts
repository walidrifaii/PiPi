...
/** V3 storefront: inactive products are hidden from customers. */
@Controller({ path: 'merchants', version: '3' })
export class MerchantStorefrontV3Controller extends MerchantController {
  constructor(
